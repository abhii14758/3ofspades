...
export const socketEmit = {
  createRoom: (payload: { roomName: string; playerName: string; config?: Partial<RoomConfig>; presetAvatarId?: string; avatarType?: 'preset' | 'upload'; avatarUrl?: string; equippedFrameId?: string }) =>
